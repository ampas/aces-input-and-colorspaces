...
// <ACEStransformID>urn:ampas:aces:transformId:v2.0:CSC.Academy.ACES_to_ACESproxy10i.a2.v1</ACEStransformID>
...
const float AP0_to_AP1_MAT[3][3] = calculate_rgb_to_rgb_matrix( AP0, AP1);
